...
export function AboutHeroSection() {
  return (
    <section className="text-center">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-5 tracking-tight text-balance">
      ...
      <div className="mt-10 relative w-full max-w-3xl mx-auto aspect-[21/10] rounded-lg overflow-hidden border">
        <Image
